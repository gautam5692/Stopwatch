...
function createButtons() {
  const buttons = {
    stop: createButton("Stop", stopTimer, "stop"),
    reset: createButton("Reset", resetTimer, "reset", [
      "btn-hidden",
      "slide-in-left",
    ]),
    count: createButton("Count", countTimer, "count", [
      "btn-hidden",
      "slide-in-right",
    ]),
  };
...
function createButton(label, clickHandler, id, classList = []) {
